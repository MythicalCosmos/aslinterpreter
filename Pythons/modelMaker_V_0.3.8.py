...
class GestureApp:
    ...
    def update_frame(self):
        if self.cap:
            ...
            if ret:
                ...
                # Automatic capture at 10 FPS (every 100ms)
                if self.capturing:
        ...
        self.root.after(100, self.update_frame)  # 100 ms => 10 FPS
    ...
    def toggle_capture(self):
        ...
        messagebox.showinfo("Capture", f"Automatic capture {state} for selected gestures (10 FPS)")
