...
class GestureApp:
    def __init__(self, root):
        ...
        self.checkbox_vars = {}  # gesture_dir -> BooleanVar
    ...
    def train_selected(self):
        ...
        for gesture_dir in selected_paths:
            ...
            if images:
                ...
                print(f"Skipping empty/invalid folder: {gesture_dir}")
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            try:
                ...
                if not data.labels:
                    raise RuntimeError("No labels found after dataset creation.")
                ...
                messagebox.showinfo("Training Complete", f"Accuracy: {acc:.2f}, Loss: {loss:.2f}\nModel exported to {export_path}")
