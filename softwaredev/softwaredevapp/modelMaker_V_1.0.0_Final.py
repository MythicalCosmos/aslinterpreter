...
class GestureApp:
    ...
    def build_gui(self):
        ...
        ttk.Button(control_frame, text="Train & Export Model", command=self.log_status).grid(row=0, column=3, padx=5)
